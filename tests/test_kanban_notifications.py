...
class FormatCompletionMessageTest(unittest.TestCase):
    ...
    def test_stage_change_produces_message(self):
        ...
        msg = format_completion_message(card, "coder", STAGE_CODING, "coding", "standard", 300.0, (5, 1, 10))
    ...
    def test_no_stage_change_returns_none(self):
        ...
        msg = format_completion_message(card, "coder", STAGE_CODING, "coding", "standard", 60.0, (1, 0, 5))
    ...
    def test_done_card_includes_summary(self):
        ...
        msg = format_completion_message(card, "integrator", STAGE_REVIEW, "reviewing", "standard", 120.0, (10, 0, 10))
        self.assertIsNotNone(msg)
