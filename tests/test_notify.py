...
from orc_core.notify import send_telegram_message


class NotifyTest(unittest.TestCase):
    @patch("orc_core.notify.post_telegram_message")
    @patch("orc_core.notify.resolve_telegram_credentials", return_value=("token", "chat-id", "env"))
