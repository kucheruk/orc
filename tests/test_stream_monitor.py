...
from orc_core.agents.monitoring.stream_monitor import StreamJsonMonitor
...
class StreamMonitorFormattingTest(unittest.TestCase):
    ...
    def test_reasoning_strips_basic_markdown(self) -> None:
        ...
        from orc_core.agents.monitoring.event_text import iter_event_values
    ...
    def test_extract_text_reads_message_content_list(self) -> None:
        from orc_core.agents.monitoring.event_text import extract_text
    ...
    def test_append_agent_output_writes_to_log_file(self) -> None:
        from orc_core.agents.monitoring.agent_output_sink import AgentOutputSink
        with tempfile.TemporaryDirectory() as tmpdir:
    ...
    def test_followup_detection_uses_result_error_context(self) -> None:
        from orc_core.agents.monitoring.stream_parser import is_followup_prompt_event
